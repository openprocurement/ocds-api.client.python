...
class TestWorkers(TestCase):
    ...
    def test_forward_worker(self, session):
        ...
        sleep(3)
        self.assertEquals(self.sync_client.backward_worker.ready(), False)
        self.assertEquals(self.sync_client.backward_worker.exit_successful, False)
        self.assertEquals(self.sync_client.forward_worker.ready(), False)
        self.assertEquals(self.sync_client.forward_worker.exit_successful, False)
        ...
        sleep(3)
        self.assertEquals(self.sync_client.backward_worker.ready(), True)
        self.assertEquals(self.sync_client.backward_worker.exit_successful, True)
        self.assertEquals(self.sync_client.forward_worker.ready(), False)
        self.assertEquals(self.sync_client.forward_worker.exit_successful, False)
